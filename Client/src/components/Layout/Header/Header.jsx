...
const Header = ({ user, activeView, activeTab, activeBoardId, activeSprint, onTabSelect, onAddMembers }) => {
  const { logout } = useAuth();
        ...
        <div className="project-header">
          <div className="project-title">
            <h2>
              {getBoardName()}
              {activeSprint && 
                <span className="sprint-title-separator"> / {activeSprint.name}</span>
              }
            </h2>
          </div>
